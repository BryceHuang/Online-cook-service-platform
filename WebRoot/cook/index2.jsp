			...
			<div class="pull-right">
				<div class="user-center__info bgf">
					<div class="pull-left clearfix">
						<div class="port b-r50 pull-left">
							<img id="cookHeaderPictureCon" src="" class="cover b-r50">
							<a href="UpdateCook.jsp" class="edit"><i class="iconfont icon-edit"></i></a>
						</div>
						<p class="name text-nowrap">您好，${cook.cook_rname}！</p>
						<p class="money text-nowrap">余额：¥${cook.cook_money}</p>
						<p class="level text-nowrap">身份：普通厨师 <!-- <a href="#">提升</a> --></p>
					</div>
					<div class="pull-right user-nav">
						<a href="MyOrders.jsp" class="user-nav__but">
							<i class="iconfont icon-rmb fz40 cr"></i>
							<div class="c6">待服务 <span class="cr" id="count21">1</span></div>
						</a>
						<a href="MyOrders.jsp" class="user-nav__but">
							<i class="iconfont icon-eval fz40 cr"></i>
							<div class="c6">待评价 <span class="c3" id="count41">0</span></div>
						</a>
						...
						<a href="#" class="user-nav__but">
							...
							<div class="c6">积分 <span class="cr" id="jfCount">200</span></div>
						</a> -->
				...
				<div class="order-list__div bgf">
					<div class="user-title">
						...
						<a href="MyOrders.jsp" class="pull-right">查看所有订单></a>
					</div>
...
<!-- Modal -->
<form id="applyChangeForm" action="<%=request.getContextPath()%>/cook/changeOrderAction" method="post">
...
var TableInit2 = function () {
    ...
    oTableInit2.Init = function () {
        $('#tb_onlineorder2').bootstrapTable({
            ...
            sidePagination: "server",           //分页方式：client客户端分页，server服务端分页（*）
            pageNumber:1,                       //初始化加载第一页，默认第一页
            pageSize: 10000000,                       //每页的记录行数（*）
            pageList: [10000000],        //可供选择的每页的行数（*）
            search: false,                       //是否显示表格搜索，此搜索是客户端搜索，不会进服务端，所以，个人感觉意义不大
            strictSearch: true,
            showColumns: false,                  //是否显示所有的列
            showRefresh: true,                  //是否显示刷新按钮
...
return ['<button id="TableEditor" type="button" class="btn ">开始</button><label style="cursor: pointer" for="'+row['order_id']+'"><a href="#myModal" id ="biangeng" role="button" class="btn " data-toggle="modal">变更</a><label style="cursor: pointer" for="'+row['order_id']+'">'].join("")
}
