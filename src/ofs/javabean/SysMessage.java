...
public class SysMessage  implements Serializable {  //所有需要收到的消息
	@Id
	@GeneratedValue
	...
	public SysMessage(Integer message_id, String message_sender,
	...
	public String toString() {
		return "SysMessage [message_id=" + message_id + ", message_sender="
